...
struct cube_color
{
    ...
    easy_vector3 bottom;
    cube_color():
        face(MCC_BLACK),back(MCC_BLACK),left(MCC_BLACK),
        right(MCC_BLACK),top(MCC_BLACK),bottom(MCC_BLACK)
    {
    }
    cube_color(easy_vector3 face_color, easy_vector3 back_color, easy_vector3 left_color,
        ...
        face(face_color),back(back_color),left(left_color),
        right(right_color),top(top_color),bottom(bottom_color)
    {
    }
};
